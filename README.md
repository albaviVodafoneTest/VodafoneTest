...
| Name | Type |
|------|------|
| [dns_a_record_set.dns-set](https://registry.terraform.io/providers/hashicorp/dns/latest/docs/resources/a_record_set) | resource |

## Inputs

| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| <a name="input_pathJson"></a> [pathJson](#input\_pathJson) | Path to the JSON files containing A type reg | `string` | `"/examples/exercise/input-json/"` | no |
